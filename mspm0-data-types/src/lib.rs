...
impl fmt::Display for PeripheralType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let content = match self {
            ...
            PeripheralType::Unicomm => "uc",
            PeripheralType::UnicommSpi => "uc_spi",
            PeripheralType::UnicommUart => "uc_uart",
            PeripheralType::UnicommI2CC => "uc_i2cc",
            PeripheralType::UnicommI2CT => "uc_i2ct",
